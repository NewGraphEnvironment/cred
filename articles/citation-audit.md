...
#> Wrote 9 rows to /tmp/RtmpuX9DJa/audit_1d42728fb2aa.csv
```
...
#> Sorted by 'status' and wrote 9 rows to /tmp/RtmpuX9DJa/audit_1d42728fb2aa.csv
```
...
#> File: /tmp/RtmpuX9DJa/audit_1d42728fb2aa.csv 
#> Total rows: 9 
#> 
#> -- Status breakdown --
#> # A tibble: 3 × 2
