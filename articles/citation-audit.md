...
#> Wrote 5 rows to /tmp/RtmpRKBk1D/audit_1cd53766d861.csv
```
...
#> Sorted by 'status' and wrote 5 rows to /tmp/RtmpRKBk1D/audit_1cd53766d861.csv
```
...
#> File: /tmp/RtmpRKBk1D/audit_1cd53766d861.csv 
#> Total rows: 5 
#> 
#> -- Status breakdown --
#> # A tibble: 3 × 2
