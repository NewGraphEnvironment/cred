...
#> Wrote 9 rows to /tmp/RtmpcCGt3z/audit_1ca852d96c06.csv
```
...
#> Sorted by 'status' and wrote 9 rows to /tmp/RtmpcCGt3z/audit_1ca852d96c06.csv
```
...
#> File: /tmp/RtmpcCGt3z/audit_1ca852d96c06.csv 
#> Total rows: 9 
#> 
#> -- Status breakdown --
#> # A tibble: 3 × 2
